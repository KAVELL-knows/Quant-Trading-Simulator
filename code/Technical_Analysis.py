...
def technical_analysis(symbol):
    ...
    return {
        ...
        "Bullish Indicators": bullish_signals,
        "Bearish Indicators": bearish_signals,
        "Bullish Agreement": bullish_directional_agreement,
        "Bearish Agreement": bearish_directional_agreement,
        "Total Active Signals": total_active_signals,
